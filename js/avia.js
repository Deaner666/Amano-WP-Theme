...
(function($)
{
	$.fn.aviaMegamenu = function(variables) 
	{
		...
		return this.each(function()
		{
			...
			//bind event for mega menu
			//new event written by Dave
			megaItems.each(function(i){
			
				$(this).mouseup( //$(this).hover( <--CHANGED BY DAVE
				
					function()
					{
						//TODO Check if menu is already showing and remove it if it is
						delayCheck[i] = true;
						setTimeout(function(){megaDivShow(i); },0);
					}
				);
