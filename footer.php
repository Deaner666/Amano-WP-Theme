		...
		?>
			<script src="<?php echo get_option("siteurl"); ?>/wp-content/themes/abundance/js/jquery.cookie.js" type="text/javascript"></script>
			<script src="<?php echo get_option("siteurl"); ?>/wp-content/themes/abundance/js/jquery.textresizer.js" type="text/javascript"></script>
		<?php
